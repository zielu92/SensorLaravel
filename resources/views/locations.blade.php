                        ...
                        <div class="card shadow">
                            <div class="card-body">
                                ...
                                <div class="text-center">
                                    @if($location->device->where('id', '=', $location->lastUpdatedDevice())->first()->lastRecord('PM1')!="")
                                        <div class="gauge" id="chartLocationPM1{{$location->id}}" style="height: 120px;"></div>
                                    @endif
                                    @if($location->device->where('id', '=', $location->lastUpdatedDevice())->first()->lastRecord('PM2.5')!="")
                                        <div class="gauge" id="chartLocationPM25{{$location->id}}" style="height: 120px;"></div>
                                    @endif
                                    @if($location->device->where('id', '=', $location->lastUpdatedDevice())->first()->lastRecord('PM10')!="")
                                        <div class="gauge" id="chartLocationPM10{{$location->id}}" style="height: 120px;"></div>
                                    @endif
                                </div>
                                <p> @if($location->device->where('id', '=', $location->lastUpdatedDevice())->first()->lastRecord('TEMPERATURE')!="")
                                        Temperature: <b>{{$location->device->where('id', '=', $location->lastUpdatedDevice())->first()->lastRecord('TEMPERATURE')}} °C</b><br>
                                    @endif
                                    @if($location->device->where('id', '=', $location->lastUpdatedDevice())->first()->lastRecord('PRESSURE')!="")
                                        Pressure: <b>{{$location->device->where('id', '=', $location->lastUpdatedDevice())->first()->lastRecord('PRESSURE')}} hPa</b><br>
                                    @endif
                                    @if($location->device->where('id', '=', $location->lastUpdatedDevice())->first()->lastRecord('LUX')!="")
                                        Light: <b>{{$location->device->where('id', '=', $location->lastUpdatedDevice())->first()->lastRecord('LUX')}} Lux</b><br>
                                    @endif
                                    @if($location->device->where('id', '=', $location->lastUpdatedDevice())->first()->lastRecord('PM1')!="")
                                        PM1: <b>{{$location->device->where('id', '=', $location->lastUpdatedDevice())->first()->lastRecord('PM1')}} μg/m3</b><br>
                                    @endif
                                    @if($location->device->where('id', '=', $location->lastUpdatedDevice())->first()->lastRecord('PM2.5')!="")
                                        PM2.5: <b>{{$location->device->where('id', '=', $location->lastUpdatedDevice())->first()->lastRecord('PM2.5')}} μg/m3</b><br>
                                    @endif
                                    @if($location->device->where('id', '=', $location->lastUpdatedDevice())->first()->lastRecord('PM10')!="")
                                        PM10: <b>{{$location->device->where('id', '=', $location->lastUpdatedDevice())->first()->lastRecord('PM10')}} μg/m3</b><br>
                                    @endif
        ...
        @foreach($locations as $location)
            @if($location->device->where('id', '=', $location->lastUpdatedDevice())->first()->lastRecord('PM1')!="")
                ...
                function drawChartPM1{{$location->id}}() {
                    var data = google.visualization.arrayToDataTable([
                        ['Label', 'Value'],
                            @if($location->device->where('id', '=', $location->lastUpdatedDevice())->first()->lastRecord('PM1') != null)
                        ['PM1', {{$location->device->where('id', '=', $location->lastUpdatedDevice())->first()->lastRecord('PM1')}}],
                        @endif
                    ]);
            ...
            @if($location->device->where('id', '=', $location->lastUpdatedDevice())->first()->lastRecord('PM2.5')!="")
                ...
                function drawChartPM25{{$location->id}}() {
                    var data = google.visualization.arrayToDataTable([
                        ['Label', 'Value'],
                        @if($location->device->where('id', '=', $location->lastUpdatedDevice())->first()->lastRecord('PM2.5') != null)
                            ['PM2.5', {{$location->device->where('id', '=', $location->lastUpdatedDevice())->first()->lastRecord('PM2.5')}}],
                        @endif
                    ]);
            ...
            function drawChartPM10{{$location->id}}() {
                var data = google.visualization.arrayToDataTable([
                    ['Label', 'Value'],
                    @if($location->device->where('id', '=', $location->lastUpdatedDevice())->first()->lastRecord('PM10') != null)
                        ['PM10', {{$location->device->where('id', '=', $location->lastUpdatedDevice())->first()->lastRecord('PM10')}}],
                    @endif
                ]);
